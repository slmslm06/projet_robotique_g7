// ============================================================
//  PARCOURS COMPLET v10.3
//
//  CHANGEMENTS vs v9 :
//   - TUNNEL : COPIE EXACTE de code_tunnel.ino (suivi mur droit)
//   - SECTIONS 5-6-7 INTEGREES (apres l'evitement O2)
//
//  CORRECTIONS v10.3 :
//   - DETECTION ENTREE TUNNEL : option C (copie code_tunnel) :
//     * Timer 500 ms apres perte de ligne (au lieu de compteur)
//     * AUCUNE detection d'obstacle frontal avant le tunnel
//       (sinon le mur du tunnel etait pris pour un obstacle a
//        eviter -> declenchement intempestif de evitementGauche)
//   - O1 : utilise DIST_DEPASSEMENT1 = 40 cm (a la place de
//          DIST_DEPASSEMENT = 35 cm utilise par O2)
//   - Servo : delay du retour au centre augmente a 350-400 ms
//             pour laisser le temps physique au mouvement
//
//  CORRECTIONS v10.2 :
//   - O1 : refonte en MIROIR EXACT d'O2 + pivot 70 gauche final
//
//  CORRECTIONS v10.1 :
//   - Tunnel : restaure EXACTEMENT la logique de code_tunnel.ino
//   - O1/O2 : post-evitement active AVANT chercherLigne
//   - Servo : helper "assurerServoAvant()" en debut de suivi ligne
//
//  LOGIQUE DU PARCOURS :
//   ATTENTE_DEPART
//      -> SUIVI_LIGNE (section 1 : V1 + L1)
//      -> TUNNEL (section 2)                  [ligne perdue > 500ms]
